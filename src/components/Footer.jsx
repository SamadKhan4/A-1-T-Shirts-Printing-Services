...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-black/8 py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
          <div className="max-w-xs">
            ...
            <p className="font-outfit text-black/45 text-xs leading-relaxed">
        ...
        <div className="mt-16 pt-8 border-t border-black/8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-outfit text-xs text-black/35 tracking-wider">
            (c) 2026 A-1 T-Shirt and Printing Services. All rights reserved.
          </p>
          <p className="flex items-center gap-1.5 font-outfit text-xs tracking-wider text-black/45">
            <span>Made with</span>
            <svg
              aria-label="love"
              className="h-3.5 w-3.5 fill-lavender text-lavender"
              viewBox="0 0 24 24"
              role="img"
            >
            ...
            <span>by</span>{" "}
            <a href="#" className="text-black/70 underline decoration-lavender/50 underline-offset-4 hover:text-lavender">
              SAMAD KHAN
            </a>
          </p>
          <p className="font-garamond italic text-lavender/70 text-sm">
